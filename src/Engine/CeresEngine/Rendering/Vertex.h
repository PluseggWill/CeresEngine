...
struct Vertex
{
	// TODO: UV
	Vertex() {}
	Vertex(const XMFLOAT3& p, const XMFLOAT3& n, const XMFLOAT4& c,
		   const XMFLOAT3& t, const XMFLOAT2& uv)
		: Position(p), Normal(n), Color(c), TangentU(t), TexC(uv) {}
	Vertex(
		...
		: Position(px, py, pz), Normal(nx, ny, nz), Color(cr, cg, cb, ca),
